...
# Load metadata
metadata_archaea_species <- read.csv("RRMS_metadata.csv", row.names = 1, check.names = F)
...
fit_data_ms <- Maaslin2(
  ...
  output = "RRMS/archaea_ms",
  fixed_effects = c("MS", "sex", "age", "weight", "height", "allergy", "diet", "site",
                    "Beta.carotene", "Fat", "Good.oils", "Sweets..of.cals", "Calcium"),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
  standardize = FALSE
...
fit_data_ms <- Maaslin2(
  ...
  output = "bacteria_ms",
  fixed_effects = c("MS", "sex", "age", "weight", "height", "allergy", "diet", "site", "smoke", "pets",
                    "Alcohol...of.cals", "Beta.carotene", "Calories", "Carbohydrate", "Cholesterol", "Dietary.Fiber",
                    "Fat", "Good.oils", "Potassium", "without.potatoes", "Vitamdietpairsumin.A", "Calcium"),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
  standardize = FALSE
...
fit_data_ms <- Maaslin2(
  ...
  output = "RRMS/fungi_ms",
  fixed_effects = c("MS", "weight", "bmi", "allergy",
                    "Calories", "Fat", "Good.oils", "Polyunsaturated.fat"),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
  standardize = FALSE
...
fit_data_ms <- Maaslin2(
  ...
  output = "virus_ms",
  fixed_effects = c("MS", "sex", "weight", "height", "allergy", "site", "smoke", "smoke", "weight_change", "Treatment",
                    "Alcohol...of.cals", "Good.oils", "Potassium", "Saturated.fat", "Vitamdietpairsumin.A"),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
  standardize = FALSE
...
fit_data_ms <- Maaslin2(
  ...
  output = "ko_ms",
  fixed_effects = c("MS", "sex", "age", "weight", "allergy", "diet", "site", "smoke", "Treatment",
                    "Alcohol...of.cals", "Carbohydrate", "Cholesterol", "Dietary.Fiber", "Fat", "Fat.as...of.cals",
                    "Potassium", "Calcium" ),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
...
fit_data_ms <- Maaslin2(
  ...
  output = "path_ms",
  fixed_effects = c("MS", "sex", "age", "weight", "height", "allergy", "diet", "site", "smoke",
                    "Alcohol...of.cals", "Carbohydrate", "Cholesterol", "Dietary.Fiber", "Fat", "Monounsaturated.fat",
                    "Niacin", "Potassium", "Calcium"),
  normalization = "NONE",
  transform = "NONE",
  analysis_method = "LM",
  standardize = FALSE
