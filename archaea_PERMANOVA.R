...
adonis_result <- adonis(bray_curtis_dist ~ ., data = metadata_archaea[, phenotype_vars], permutations = 9999, by = "margin")
...
adonis_result_diet <- adonis(bray_curtis_dist ~ ., data = metadata_archaea_diet[, phenotype_vars], permutations = 9999, by = "margin")
